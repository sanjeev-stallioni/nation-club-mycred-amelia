...
function nc_statement_build_pdf_html( $row ) {
    ...
    <div class="wrap">
        ...
        <p style="margin-top:18px;padding:9px 11px;background:#f7f2f4;border-left:3px solid #8b1c3b;color:#555;font-size:10px;line-height:1.5">
            <strong>Note:</strong> Shared costs, subscription fees and other cash charges are separate from the Nation Club Points Pool. If one Wise payment is made for both shared costs and Points Pool top-up, shared costs will be allocated first, and only the remaining balance will be credited to the Vendor’s Points Pool.
        </p>
